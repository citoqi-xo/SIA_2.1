...
import com.service.SubTransService;
 ...
 * @author ARCH
 */
public class subTransaksi extends javax.swing.JInternalFrame {
GridBagLayout layout = new GridBagLayout();

PemasukanQuery pemQue;
SubTransQuery strkQue;
PendapatanQuery pendQue;
SubTransService subtSvc;
...
String setIdUser;
    ...
    private void initComponents() {
        ...
        TtlPend = new javax.swing.JFormattedTextField();
        ...
        TtlPend.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0"))));
            ...
            .addGroup(panelGlass3Layout.createSequentialGroup()
                ...
                .addGroup(panelGlass3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(panelGlass3Layout.createSequentialGroup()
                        ...
                        .addComponent(TtlPend, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(116, 116, 116)))
        ...
        panelGlass3Layout.setVerticalGroup(
            ...
            .addGroup(panelGlass3Layout.createSequentialGroup()
                ...
                .addGroup(panelGlass3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(TtlPend, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(8, 8, 8)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(panelGlass9, javax.swing.GroupLayout.PREFERRED_SIZE, 773, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(panelBayangan, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)))
                .addComponent(panelGlass3, javax.swing.GroupLayout.PREFERRED_SIZE, 458, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private javax.swing.JFormattedTextField TtlPend;
    ...
    private void loadTabel(){
        ...
        pendQue.viewTotalPendapatan(tglVw, TtlPend);
        focus();
    }
    ...
    public void MatEdit(){
        ...
        if(TtlPend.getText().isEmpty()){
            subtSvc.addMat(isiTtlPendapatan,isiTtlPendapatan);
        } else{
            if(TtlPend.getText().equals(isiTtlPendapatan.getText())){
                JOptionPane.showMessageDialog(this, "Jumlah transaksi anda masih sama");
            }else{
                subtSvc.editMat(isiTtlPendapatan,TtlPend,isiTtlPemasukan);
            }
        }
    ...
    private void focus(){
        ...
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                isiTtlPendapatan.requestFocusInWindow();
                isiTtlPemasukan.requestFocusInWindow();
                TtlPend.requestFocusInWindow();
            }
        });
     }
