...
public class laporanPemasukan extends javax.swing.JPanel {
   GridBagLayout layout = new GridBagLayout();
    ...
    public laporanPemasukan() {
        ...
        pemsQue = new PemasukanQuery() ;
        cetPr = new PemasukanCtk();
    ...
    private void initComponents() {
        ...
        tabelPemsk = new javax.swing.JTable();
        ...
        tabelPemsk.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tabelPemsk);
    ...
    private javax.swing.JTable tabelPemsk;
    ...
    private void loadTabel(){
        List<String[]> result = pemsQue.viewPemsTrk(tglVw);
            ...
            if(dateAkhir.getDate()==null){
             ...
             if(dateAkhir.getDate()==null){
                ...
                try{
                    ...
                    model.fireTableDataChanged();
                    tabelPemsk.setModel(model);
                    List<String[]> result= pemsQue.lapPeroide(dateAwl,dateAkh);
                    for(int i = 0; i < result.size();i++){
                        model.addRow(result.get(i));
                    }
                }
    ...
    private void bulan(){
        ...
        if(bulanAwl>=0||bulanAkh>=0){
            if(bulanAwl<9||bulanAkh<9){
                ...
                String xdateAwl= "0"+kalDateAwl;
                int kalDateAkh = bulanAkh+1;
                String xdateAkh= "0"+kalDateAkh;
                try{
                    model.getDataVector().removeAllElements();
                    model.fireTableDataChanged();
                    tabelPemsk.setModel(model);
                    List<String[]> result=  pemsQue.lapBulan(tahunAwl,tahunAkh,xdateAwl,xdateAkh);
                    for(int i = 0; i < result.size();i++){
                     model.addRow(result.get(i));
                    }
                }
                ...
                int kalDateAwl = bulanAwl+1;
                String xdateAwl= ""+kalDateAwl;
                int kalDateAkh = bulanAkh+1;
                String xdateAkh= ""+kalDateAkh;
        ...
        if(bulanAwl>=0||bulanAkh>=0){
            if(bulanAwl<9||bulanAkh<9){
                ...
                try{
                    ...
                    model.fireTableDataChanged();
                    tabelPemsk.setModel(model);
                    List<String[]> result=  pemsQue.lapPerBulan(tahunAwl,tahunAkh,xdateAwl,xdateAkh);
                    for(int i = 0; i < result.size();i++){
                     model.addRow(result.get(i));
                    }
                }
     ...
     private void ssearchAction() {
       //To change body of generated methods, choose Tools | Templates.
            try{
                ...
                model.fireTableDataChanged();
                tabelPemsk.setModel(model);
                List<String[]> result=  pemsQue.fcSelectCommand(txtSearch);
                for(int i = 0; i < result.size();i++){
                     model.addRow(result.get(i));
                }
            }
             ...
             if(bulanAwl==bulanAkh && tahunAwl==tahunAkh){
                  if(bulanAwl>=0||bulanAkh>=0){
                      if(bulanAwl<9||bulanAkh<9){
                          int kalDateAwl = bulanAwl+1;
                          String xdateAwl= "0"+kalDateAwl;
                          String xTahAwl = ""+tahunAwl+"-"+xdateAwl;
                          cetPr.cetBulan("/laporan/pmsukPb.jrxml",xTahAwl);
                      }
                  }else{
                      int kalDateAwl = bulanAwl+1;
                      String xdateAwl= ""+kalDateAwl;
                 ...
                 if(bulanAwl>=0||bulanAkh>=0){
                      if(bulanAwl<9||bulanAkh<9){
                          ...
                          String xdateAkh= "0"+kalDateAkh;
                          String xTahAwl = ""+tahunAwl+"-"+xdateAwl;
                          String xTahAkh = ""+tahunAkh+"-"+xdateAkh;
                          cetPr.cetPerBulan("/laporan/pmsukBp.jrxml",xTahAwl,xTahAkh);
                      }
                  }else{
                      int kalDateAwl = bulanAwl+1;
                      String xdateAwl= ""+kalDateAwl;
                      ...
                      String xTahAwl = ""+tahunAwl+"-"+xdateAwl;
                      String xTahAkh = ""+tahunAkh+"-"+xdateAkh;
                      System.out.println(" awl" +xTahAwl);
                      cetPr.cetPerBulan("/laporan/pmsukBp.jrxml",xTahAwl,xTahAkh);
                  }
            ...
            if(dateAwal.getDate()==null){
                if(dateAkhir.getDate()==null){
                 ...
                 if(dateAkhir.getDate()==null){
                    ...
                    String dateAwl =  ft.format(dateAwal.getDate());
                    String dateAkh =  ft.format(dateAkhir.getDate());
                    cetPr.cetPeriode("/laporan/pmsukPer.jrxml",dateAwl,dateAkh);
                }               
            }
        }
     }
