 ...
 * @author ARCH
 */
public class laporanAruskas extends javax.swing.JPanel {
...
ArusKasCtk cetPr;
    ...
    public laporanAruskas() {
        ...
        //menampilkan data
         ...
         model.addColumn("Tunai");
         model.addColumn("Bank A");
         model.addColumn("Bank B");
         model.addColumn("Bank C");
         model.addColumn("Pemasukan");
         model.addColumn("Pengeluaran");
         model.addColumn("Saldo Akhir");
         model.addColumn("Setoran Tunai");
         model.addColumn("Sisa Usaha");
            ...
            if(dateAkhir.getDate()==null){
             ...
             if(dateAkhir.getDate()==null){
                ...
                try{
                    ...
                    model.fireTableDataChanged();
                    tabelAruskas.setModel(model);
                    List<String[]> result= arusQue.lapPeroide(dateAwl,dateAkh);
                    for(int i = 0; i < result.size();i++){
                        model.addRow(result.get(i));
                    }
                }
    ...
    public void cariBulan(){
        ...
        if(bulanAwl==bulanAkh&&tahunAkh==tahunAwl){
            ...
            tabelAruskas.setModel(model);
            System.out.println(xdateAkh);
            List<String[]> result=  arusQue.lapBulan(tahunAwl,tahunAkh,xdateAwl,xdateAkh);
            for(int i = 0; i < result.size();i++){
                model.addRow(result.get(i));
            }
        }else{
            cekTanggal();
            System.out.println("bulan thn beda ");
            System.out.println(xdateAkh);
            System.out.println(xdateAwl);
            System.out.println(tahunAwl);
            System.out.println(tahunAkh);
            model.getDataVector().removeAllElements();
            model.fireTableDataChanged();
            tabelAruskas.setModel(model);
            List<String[]> result=  arusQue.lapPerBulan(tahunAwl,tahunAkh,xdateAwl,xdateAkh);
            for(int i = 0; i < result.size();i++){
                model.addRow(result.get(i));
            }         
        }
    ...
    private void perBulan(){
        ...
        if(bulanAwl>=0||bulanAkh>=0){
            if(bulanAwl<9||bulanAkh<9){
                ...
                System.out.println("blalalalalasjdaklda");
                int kalDateAwl = bulanAwl+1;
                xdateAwl= ""+kalDateAwl;
                int kalDateAkh = bulanAkh+1;
                xdateAkh= ""+kalDateAkh;
     ...
     private void ssearchAction() {
       //To change body of generated methods, choose Tools | Templates.
            try{
                ...
                model.fireTableDataChanged();
                tabelAruskas.setModel(model);
                List<String[]> result=  arusQue.fcSelectCommand(txtSearch);
                for(int i = 0; i < result.size();i++){
                     model.addRow(result.get(i));
                }
            }
        ...
        int tahunAkh =  tahunAkhir.getYear();
         if (dateAwal.getDate()==null && dateAkhir.getDate()==null){
             if(bulanAwl==bulanAkh && tahunAwl==tahunAkh){
                 ...
                 cetPr.cetBulan("/laporan/lapAruPb.jrxml",xTahAwl);
             } else{
                 cekTanggal();
                 xTahAwl = ""+tahunAwl+"-"+xdateAwl;
                 xTahAkh = ""+tahunAkh+"-"+xdateAkh;
                 cetPr.cetPerBulan("/laporan/lapAruBp.jrxml",xTahAwl,xTahAkh);
             }
         }else{
            if(dateAwal.getDate()==null){
                if(dateAkhir.getDate()==null){
                 ...
                 if(dateAkhir.getDate()==null){
                    ...
                    String dateAwl =  ft.format(dateAwal.getDate());
                    String dateAkh =  ft.format(dateAkhir.getDate());
                    cetPr.cetPeriode("/laporan/lapAruPer.jrxml",dateAwl,dateAkh);
                }               
            }
        }
     }
